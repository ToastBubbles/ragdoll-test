...
function legToBody(leg) {
  ...
  if (leg == rightLegCSS) {
    ...
    legPosContainer[2] =
      bodyHorizontal - document.getElementById("left-leg").offsetWidth;
    legPosContainer[3] = bodyVertical + width;
    legCenter = center2;
    ...
    legPosContainer[2] =
      bodyHorizontal - document.getElementById("left-arm").offsetWidth;
    legPosContainer[3] = bodyVertical;
    legCenter = center4;
  ...
  if (leg == rightLegCSS) {
    var angleDeg = Math.atan2(
      window.screen.height - bodCenter[1] - (window.screen.height - center1[1]),
      -1 * (bodCenter[0] - center1[0])
    );
    ...
    if (
      center1[0] <= bodCenter[0] + width / 1.8 &&
      center1[1] <= bodCenter[1] + width / 1.8
    ) {
      legPosContainer[0] = x;
      legPosContainer[1] = y;
    }
    ...
    var angleDeg = Math.atan2(
      window.screen.height - bodCenter[1] - (window.screen.height - center2[1]),
      bodCenter[0] - center2[0]
    );
    let x = bodCenter[0] - (width / 2) * Math.cos(angleDeg); //+legWidth/2;
    let y = bodCenter[1] + (width / 2) * Math.sin(angleDeg); //+legWidth/2;
    ...
    //console.log(x,y)
    if (
      center2[0] >= bodCenter[0] - width / 1.8 &&
      center2[1] <= bodCenter[1] + width / 1.8
    ) {
      //console.log("inside")
    ...
    var angleDeg = Math.atan2(
      window.screen.height - bodCenter[1] - (window.screen.height - center3[1]),
      -1 * (bodCenter[0] - center3[0])
    );
    let x = bodCenter[0] + (width / 2) * Math.cos(angleDeg); //+legWidth/2;
    let y = bodCenter[1] + (width / 2) * Math.sin(angleDeg); //+legWidth/2;
    ...
    if (
      center3[0] <= bodCenter[0] + width / 1.8 &&
      center3[1] >= bodCenter[1] - width / 1.8
    ) {
      //console.log("inside")
      legPosContainer[0] = x;
    ...
    var angleDeg = Math.atan2(
      window.screen.height - bodCenter[1] - (window.screen.height - center4[1]),
      bodCenter[0] - center4[0]
    );
    let x = bodCenter[0] - (width / 2) * Math.cos(angleDeg); //+legWidth/2;
    let y = bodCenter[1] + (width / 2) * Math.sin(angleDeg); //+legWidth/2;
    ...
    //console.log(x,y)
    if (
      center4[0] >= bodCenter[0] - width / 1.8 &&
      center4[1] <= bodCenter[1] + width / 1.8
    ) {
      legPosContainer[0] = x - width / 2.2;
      legPosContainer[1] = y - width / 2.2;
    }
    ...
    var angleDeg = Math.atan2(
      window.screen.height - bodCenter[1] - (window.screen.height - centerH[1]),
      bodCenter[0] - centerH[0]
    );
    let x = bodCenter[0] - (width / 2) * Math.cos(angleDeg); //+legWidth/2;
    let y = bodCenter[1] + (width / 2) * Math.sin(angleDeg); //+legWidth/2;
    ...
    //console.log(x,y)
    if (
      centerH[0] >= bodCenter[0] - width / 1.8 &&
      centerH[1] >= bodCenter[1] - width / 1.8 &&
      centerH[0] > bodCenter[0]
    ) {
